...
import "./PostJobSuccessmodal.css";





const PostJobSuccessmodal = () => {

    return (
        <div className="modal fade come-from-modal right text-center" id="postJobSuccessmodal" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
