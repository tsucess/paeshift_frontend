                  ...
                  <Form className="edit_profile_form">
                    ...
                    <div className="row form_row">
                      ...
                      <div className="col-12 email">
                        ...
                        <Field name="email" className="form-control" placeholder={profile.email} value={profile.email} readOnly />
                      </div>
                    </div>
                ...
                <div className="bottom_section">
                  {filteredPayments && filteredPayments.length > 0 ? (
                    filteredPayments.map((payment, index) => (
                      <div className="transaction" key={index} onClick={() => viewPaymentDetails(payment)}>
                        <span className="profile_info">
                          <span className="profileWrapper">
                            <img
                              className="prof"
                              src={payment.payment_method === "paystack" ? iconWema : iconLogo}
                        ...
                        <h3 className={payment.status === "Completed" ? "credit-amount" : "debit-amount"}>
                          ₦{payment.amount}
                        </h3>
                      </div>
                    ))
