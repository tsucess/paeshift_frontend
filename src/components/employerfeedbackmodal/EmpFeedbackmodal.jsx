...
const EmpFeedbackmodal = ({ jobId, receiverIds, modalId = "EmpFeedbackModal", onFeedbackSubmitted }) => {
    ...
    const hasRequiredData = jobId && receiverIds &&
                           (typeof receiverIds === 'string' ? receiverIds.length > 0 :
            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header border-0">
                        <h1 className="modal-title fs-5" id="staticBackdropLabel">Feedback Employer</h1>
                    ...
                    <div className="modal-body mb-0 pb-0">
                        ...
                        <Formik
                            ...
                            onSubmit={async (values, { setSubmitting }) => {
                                ...
                                const selectedUserId = [receiverIds]

                                let feedbackdata = {
                                    sender_id: Number(currentUserId),
                                    receiver_id: selectedUserId, // Use the selected user's id
                                    job_id: jobId,
                                ...
                                <Form >
                                    ...
                                    <div className="row">
                                        <div className="col-12 mb-3">
                                            ...
                                            <span className="text-count">{values.feedback ? values.feedback.length : 0}/2000</span>
                                    ...
                                    <div className="row m-0 p-0 mt-3">
                                        ...
                                        <div className="col-6 ps-2">
                                            <button
                                                ...
                                                disabled={feedbackSubmitted || isCheckingFeedback}
                                            >
...
export default EmpFeedbackmodal